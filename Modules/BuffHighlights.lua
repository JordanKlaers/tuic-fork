...
local function UpdateHighlightFrame(slotIndex)
    ...
    -- Mirror count from source icon (Blizzard's count is already correct)
    if sourceIcon then
        local countText = ""
        pcall(function()
    ...
    if enabled then
        ...
        C_Timer.After(0.3, function()
            if TUICD.LayoutMode and TUICD.LayoutMode.Unlock then
                ...
                print("|cff00ccff[TUI:CD]|r Per-Icon #" .. slotIndex .. " created. Position it now!")
            else
                print("|cff00ccff[TUI:CD]|r Per-Icon #" .. slotIndex .. " created. Use /tuicdlayout to position.")
            end
        end)
    else
        if highlightFrames[slotIndex] then
...
SlashCmdList["TUIBUFFHIGHLIGHTS"] = function(msg)
    ...
    elseif cmd == "state" then
        ...
        local slotIndex = tonumber(args[2]) or 1
        print("|cff00ff00=== Per-Icon State for Slot " .. slotIndex .. " ===|r")
